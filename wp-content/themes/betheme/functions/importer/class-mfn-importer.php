...
class Mfn_Importer {
	...
	function import(){
		...
		if( isset( $_POST['Mfn_Importer_nonce'] ) ){
			...
			if ( wp_verify_nonce( $_POST['Mfn_Importer_nonce'], 'mfn-importer-nonce' ) ){
	...
	function import_html( $status, $output = '' ){
		...
		<div id="mfn-wrapper" class="mfn-demo-data wrap">
			...
			<form id="form" action="" method="post">
				...
				<input type="hidden" name="Mfn_Importer_nonce" value="<?php echo wp_create_nonce( 'mfn-importer-nonce' ); ?>" />
