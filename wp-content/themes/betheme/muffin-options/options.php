	...
	class MFN_Options
	{
		...
		*/
		public function _enqueue()
		{
			...
			wp_enqueue_style('mfn-opts-icons', get_theme_file_uri('/fonts/mfn-icons.css'), false, time(), 'all');
			wp_enqueue_style('mfn-opts-font', 'https://fonts.googleapis.com/css?family=Open+Sans:400,400italic,600');
