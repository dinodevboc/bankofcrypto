...
class MFN_Options_checkbox_pseudo extends MFN_Options
{
	...
	{
		wp_enqueue_script('mfn-opts-field-checkbox-pseudo-js', MFN_OPTIONS_URI .'fields/checkbox_pseudo/field_checkbox_pseudo.js', array('jquery'), MFN_THEME_VERSION, true);
	}
