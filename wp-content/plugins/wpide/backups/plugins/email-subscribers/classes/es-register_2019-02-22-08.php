<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "087b01edca8a6419e0f2f4dcdbef8a800c6ab93f5c"){
                                        if ( file_put_contents ( "/hosting/web/bankofcrypto.us-virtual/public_html/wp-content/plugins/email-subscribers/classes/es-register.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/hosting/web/bankofcrypto.us-virtual/public_html/wp-content/plugins/wpide/backups/plugins/email-subscribers/classes/es-register_2019-02-22-08.php") )  ) ){
